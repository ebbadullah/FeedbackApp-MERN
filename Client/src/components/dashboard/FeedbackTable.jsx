        ...
        <div className="border">
                                    ...
                                    <tr key={feedback._id || index} className={`border-b ${index % 2 === 0 ? "bg-white" : "bg-gray-50"}`}>
                                        ...
                                        <td className="p-2">
                                            <div className="flex space-x-1">
                                                <button onClick={() => toggleComment(feedback._id || index)} className="text-blue-600 hover:text-blue-800 p-1" title="View Comments">
            ...
            <div className="bg-gray-50 p-2 border-t flex items-center justify-between">
                <div className="text-sm text-gray-500">
                    Showing <span className="font-medium">{paginatedFeedbacks.length}</span> of <span className="font-medium">{feedbacks.length}</span> results
                </div>
                <div className="flex items-center">
                    ...
                    <div className="flex space-x-2">
                        <button onClick={handlePrevPage} disabled={currentPage === 1} className={`px-2 py-1 border text-sm flex items-center ${currentPage === 1 ? "text-gray-400 cursor-not-allowed" : "text-gray-700 bg-white hover:bg-gray-50"}`}>
                            <ChevronLeft className="w-4 h-4 mr-1" />
                            Previous
                        </button>
                        <button onClick={handleNextPage} disabled={currentPage === totalPages || totalPages === 0} className={`px-2 py-1 border text-sm flex items-center ${currentPage === totalPages || totalPages === 0 ? "text-gray-400 cursor-not-allowed" : "text-gray-700 bg-white hover:bg-gray-50"}`}>
                            Next
