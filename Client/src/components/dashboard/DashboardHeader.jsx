    ...
    <div className="p-4 mb-4">
      <div className="flex flex-col md:flex-row justify-between mb-4 gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <button onClick={onRefresh} className="p-2 border text-gray-700 hover:bg-gray-50 flex items-center gap-1">
            <RefreshCw className="h-4 w-4" />
            <span>Refresh</span>
          </button>

          <button className="p-2 border text-gray-700 hover:bg-gray-50 flex items-center gap-1">
          ...
          <button onClick={onExport} className="p-2 bg-blue-600 text-white flex items-center gap-1">
